...
class Provider (IMapProvider):
    ...
    def getTileData(self, coord, whole):
        """
        """
        ...
        if whole:
            #saves a blank model
            name = path.split('/')
            obj = open('tile_sets/out_%s.obj' % name[4], 'w')
            count = 0
            ...
            for texture in range(textures):
                name = path.split('/')
                obj = open('out_%s_%d.obj' % (name[4],texture), 'w')
                ...
                jpg = open('out_%s_%d.jpg' % (name[4],texture), 'w')
...
if __name__ == '__main__':
    ...
    # 19_318554_94436_0_15x15
    # 19_329442_280329_0_15x15
    # map_19_329449_280336_0.jpg
    # map_19_327162_154371_0
    # map_19_327161_154373_0.jpg
    # 19_327037_154697 twa terminal
    # 19_327280_154398 lincoln center
    # 19_318580_94407 the luxor, vegas
    # map_19_327296_154426 the met
    # map_19_327142_154415_0 the navy yard
    a = 94400
    b = 318573
    d = 19
    grid = 15
